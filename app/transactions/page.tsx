...
const TransactionPage: React.FC = () => {
   ...
   * Wrapped in useCallback to satisfy react-hooks/exhaustive-deps
   */
  const fetchTransactions = useCallback(
    async (publicKey: PublicKey) => {
      ...
      try {
        ...
        const transactionsData: TransactionData[] = await Promise.all(
  ...
  /**
   * Trigger fetch when wallet or connection changes
   */
  useEffect(() => {
    if (wallet.publicKey) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#060606] to-[#0f0f0f] p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {!wallet.publicKey ? (
          ...
          <div className="text-center py-12 bg-gradient-to-br from-[#0a0a0a] to-[#1a1a1a] rounded-2xl shadow-lg">
            <div className="border-4 border-t-[#14F195] border-r-transparent border-b-transparent border-l-transparent rounded-full w-12 h-12 animate-spin mx-auto mb-4" />
          ...
          <div className="bg-gradient-to-br from-[#0a0a0a] to-[#1a1a1a] rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="flex flex-col gap-4 p-4 md:hidden">
              {transactions.map((tx) => (
                <div
                  key={tx.signature}
                  className="bg-[#141414] border border-[#333] p-4 rounded-lg shadow-md hover:border-[#14F195] transition-all"
                >
                  <div className="mb-3">
