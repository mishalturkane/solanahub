...
export function Airdrop() {
  ...
  return (
    <div className="relative">
      {/* Form */}
      <div className="max-w-md mx-auto p-6 rounded-2xl shadow-lg bg-gradient-to-br from-[#0a0a0a] to-[#1a1a1a] text-white">
      ...
      {/* Toast Notification */}
      {txSig && (
        <div className="bottom-4 right-4 bg-[#141414] border border-[#333] rounded-xl shadow-lg p-4 w-80 text-white animate-slide-in relative">
          {/* Close Button */}
          <button
